<template>
   <v-row>
          <v-dialog v-model="dialogsectiond" 
              ...
              <v-card-text>
                <v-container fluid>
                  <v-row class="subtitle-2 text--primary">
                    ...
                    <v-col cols="12" xs="12" sm="6" md="6">
                      <v-text-field label="description" filled outlined dense v-model="form.description"></v-text-field>
                    </v-col>
                    <v-col cols="12">
...
<script>
export default {
    props: ['dialogsectiond','sectiondclose', 'section', 'widget'],
    data(){
      return{
        form:{
          page: 'home',
